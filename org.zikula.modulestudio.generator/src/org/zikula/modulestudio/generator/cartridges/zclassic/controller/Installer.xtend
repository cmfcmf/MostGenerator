...
class Installer {
    ...
    def private installerBaseClass(Application it) '''
         ...
         */
        class IF targets('1.3.5')appName_Base_ELSEname.formatForCodeCapitalModuleENDIFInstaller extends Zikula_AbstractInstaller
        {
            installerBaseImpl
        }
    '''
    ...
    def private interactiveBaseClass(Application it) '''
         ...
         */
        IF targets('1.3.5')
        class appName_Controller_Base_InteractiveInstaller extends Zikula_Controller_AbstractInteractiveInstaller
        ELSE
    ...
    def private funcInit(Application it) '''
         ...
         * @throws RuntimeException Thrown if database tables can not be created or another error occurs
         ENDIF
         */
        public function install/* new base class not ready yet in the core, see MostGenerator#401 IF !targets('1.3.5')ActionENDIF*/()
        {
            ...
            IF hasCategorisableEntities
                ...
                IF targets('1.3.5')
                    ...
                    $categoryApi = new appName_Api_Category($this->serviceManager);
                ELSE
                    $categoryApi = new \vendor.formatForCodeCapital\name.formatForCodeCapitalModule\Api\CategoryApi($this->serviceManager);
                ENDIF
    ...
    def private funcUpdate(Application it) '''
         ...
         * @throws RuntimeException Thrown if database tables can not be updated
         ENDIF
         */
        public function upgrade/* new base class not ready yet in the core, see MostGenerator#401 IF !targets('1.3.5')ActionENDIF*/($oldVersion)
        {
        /*
    ...
    def private funcDelete(Application it) '''
         ...
         * @throws RuntimeException Thrown if database tables or stored workflows can not be removed
         ENDIF
         */
        public function uninstall/* new base class not ready yet in the core, see MostGenerator#401 IF !targets('1.3.5')ActionENDIF*/()
        {
            ...
            */
            ...
            IF hasUploads
                ...
                $manager = $this->getServiceManager()->getIF targets('1.3.5')ServiceENDIF('systemplugin.imagine.manager');
    ...
    def private installerImpl(Application it) '''
        IF !targets('1.3.5')
            ...
            use appNamespace\Base\name.formatForCodeCapitalModuleInstaller as Basename.formatForCodeCapitalModuleInstaller;
         ...
         */
        IF targets('1.3.5')
        class appName_Installer extends appName_Base_Installer
        ELSE
        class name.formatForCodeCapitalModuleInstaller extends Basename.formatForCodeCapitalModuleInstaller
        ENDIF
        {
    ...
    def private interactiveImpl(Application it) '''
         ...
         */
        IF targets('1.3.5')
        class appName_Controller_InteractiveInstaller extends appName_Controller_Base_InteractiveInstaller
        ELSE
