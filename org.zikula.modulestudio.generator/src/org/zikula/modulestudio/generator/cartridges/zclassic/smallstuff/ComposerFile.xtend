...
class ComposerFile {
    ...
    def private composerContent(Application it) '''
        ...
        "description": "IF documentation !== null && documentation != ''documentation.replace('"', "'")ELSEappName module generated by ModuleStudio msVersion.ENDIF",
        "version": "version",
        "type": "zikula-module",
        "license": "licenseSPDX",
        "authors": [
        ...
        "autoload": {
            "psr-4": { "vendor.formatForCodeCapital\\name.formatForCodeCapitalModule\\": "" }
        },
        "require": {
            "php": ">5.3.3"
        },
        ...
        "extra": {
            "zikula": {
                "class": "vendor.formatForCodeCapital\\name.formatForCodeCapitalModule\\appName"
            }
        }
    '''
