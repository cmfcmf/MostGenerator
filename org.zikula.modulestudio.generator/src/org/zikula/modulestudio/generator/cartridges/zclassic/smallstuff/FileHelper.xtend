...
class FileHelper {
    ...
    def private phpFileHeaderImpl(Application it) '''
        ...
        * @license license
        IF targets('1.3.5')
            * @package name
        ENDIF
        * @author authorIF email !== null && email != '' <email>ENDIF.
        * @link IF url != ''urlELSEmsUrlENDIFIF url != 'http://zikula.org'
        * @link http://zikula.orgENDIF
    '''

    def private generatedBy(Application it, Boolean includeTimestamp) '''Generated by ModuleStudio msVersion (msUrl)IF includeTimestamp at timestampENDIF.'''

    def msWeblink(Application it) '''
        <p class="IF targets('1.3.5')zELSEtextENDIF-center">
    ...
    def getterMethod(Object it, String name, String type, Boolean isMany) '''
         ...
         *
         * @return IF type == 'smallint' || type == 'bigint'integerELSEtypeENDIFIF type.toLowerCase != 'array' && isMany[]ENDIF
         */
    ...
    def setterMethod(Object it, String name, String type, Boolean isMany, Boolean useHint, String init, CharSequence customImpl) '''
         ...
         *
         * @param IF type == 'smallint' || type == 'bigint'integerELSEtypeENDIFIF type.toLowerCase != 'array' && isMany[]ENDIF $name.
         *
         * @return void
         */
        public function setname.formatForCodeCapital(IF useHinttype ENDIF$nameIF init != '' = initENDIF)
        {
    ...
    def private setterAssignmentNumeric(DerivedField it, String name, String type) '''
        ...
        IF !aggregators.empty
            ...
            $this->aggregator.sourceAlias.formatForCode->addname.formatForCodeCapitalWithoutentity.name.formatForCodeCapital($diff);
            ENDFOR
        ENDIF
    '''
