...
class ModuleDispatch {
    ...
    def generate(Application it, Boolean isBase) '''
         ...
         */
        public IF targets('1.3.5')static ENDIFfunction postLoadGeneric(IF targets('1.3.5')Zikula_EventELSEGenericEventENDIF $event)
        {
            IF !isBase
         ...
         * @param IF targets('1.3.5')Zikula_EventELSEGenericEventENDIF $event The event instance.
         */
        public IF targets('1.3.5')static ENDIFfunction preExecute(IF targets('1.3.5')Zikula_EventELSEGenericEventENDIF $event)
        {
            IF !isBase
         ...
         * @param IF targets('1.3.5')Zikula_EventELSEGenericEventENDIF $event The event instance.
         */
        public IF targets('1.3.5')static ENDIFfunction postExecute(IF targets('1.3.5')Zikula_EventELSEGenericEventENDIF $event)
        {
            IF !isBase
         ...
         * and 'event data' of `$className`. This can be altered by setting `$event->setData()` followed by `$event->stopIF !targets('1.3.5')PropagationENDIF()`.
         *
         * @param IF targets('1.3.5')Zikula_EventELSEGenericEventENDIF $event The event instance.
         */
        public IF targets('1.3.5')static ENDIFfunction customClassname(IF targets('1.3.5')Zikula_EventELSEGenericEventENDIF $event)
        {
            IF !isBase
         ...
         * @param IF targets('1.3.5')Zikula_EventELSEGenericEventENDIF $event The event instance.
         */
        public IF targets('1.3.5')static ENDIFfunction serviceLinks(IF targets('1.3.5')Zikula_EventELSEGenericEventENDIF $event)
        {
            IF !isBase
                parent::customClassName($event);

                // Format data like so:
                // $event->data[] = array('url' => ModUtil::url('appName', 'user', 'IF targets('1.3.5')mainELSEindexENDIF'), 'text' => __('Link Text'));
