...
class VersionFile {
    ...
    def private appInfoBaseImpl(Application it) '''
         ...
         */
        class IF targets('1.3.5')appName_Base_ELSEname.formatForCodeCapitalModuleENDIFVersion extends Zikula_AbstractVersion
        {
            /**
            ...
            public function getMetaData()
            {
                ...
                $meta['description']          = $this->__('IF documentation !== null && documentation != ''documentation.replace("'", "\\'")ELSEname.formatForDisplayCapital module generated by ModuleStudio msVersion.ENDIF');
        ...
        */
        ...
        val appName = appName.formatForDB
                FOR entity : getAllEntities
                    ...
                    $bundle = new IF targets('1.3.5')Zikula_HookManager_ENDIFSubscriberBundle($this->name, 'subscriber.appName.ui_hooks.areaName', 'ui_hooks', __('appName entity.nameMultiple.formatForDisplayCapital Display Hooks'));
                    ...
                    $bundle = new IF targets('1.3.5')Zikula_HookManager_ENDIFSubscriberBundle($this->name, 'subscriber.appName.filter_hooks.areaName', 'filter_hooks', __('appName entity.nameMultiple.formatForDisplayCapital Filter Hooks'));
                ...
                /* TODO see #15
                    ...
                    $bundle = new IF targets('1.3.5')Zikula_HookManager_ENDIFProviderBundle($this->name, 'provider.ratings.ui_hooks.rating', 'ui_hooks', $this->__('Ratings Hook Poviders'));
    ...
    def private appInfoImpl(Application it) '''
        IF !targets('1.3.5')
            ...
            use appNamespace\Base\name.formatForCodeCapitalModuleVersion as Basename.formatForCodeCapitalModuleVersion;
         ...
         */
        IF targets('1.3.5')
        class appName_Version extends appName_Base_Version
        ELSE
        class name.formatForCodeCapitalModuleVersion extends Basename.formatForCodeCapitalModuleVersion
        ENDIF
        {
    ...
    def private permissionSchema(Application it) '''
        $meta['securityschema'] = array(
            ...
            ENDIF
            FOR entity : getAllEntitiesentity.permissionSchema(appName)ENDFOR
        );
    ...
    def private appDependency(Application app, ReferredApplication it) '''
        array('modname'    => 'name.formatForCode.toFirstUpper',
              ...
              'status'     => ModUtil::DEPENDENCY_appDependencyTypeIF !app.targets('1.3.5'),
    ...
    def private permissionSchema(Entity it, String appName) '''
        ...
        IF !incomingRelations.empty
            FOR relation : incomingRelationsrelation.permissionSchema(appName)ENDFOR
        ENDIF
    '''
