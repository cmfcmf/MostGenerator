...
class Interactive {
    ...
    def generate(Application it) '''
        ...
        IF needsConfigfuncInteractiveInitStep2
    ...
    def private funcInteractiveInit(Application it) '''
         ...
         * @throws AccessDeniedException Thrown if the user doesn't have required permissions
         ENDIF
         */
        public function installIF !targets('1.3.5')ActionENDIF()
        {
            IF targets('1.3.5')
    ...
    def private funcInteractiveInitStep2(Application it) '''
         ...
         * @throws AccessDeniedException Thrown if the user doesn't have required permissions
         ENDIF
         */
        public function interactiveinitstep2IF !targets('1.3.5')ActionENDIF()
        {
            IF targets('1.3.5')
                $this->throwForbiddenUnless(SecurityUtil::checkPermission('::', '::', ACCESS_ADMIN));
            ELSE
            ...
            $activate = (bool) $this->request->request->filter('activate', false, IF !targets('1.3.5')false, ENDIFFILTER_VALIDATE_BOOLEAN);
    ...
    def private funcInteractiveInitStep3(Application it) '''
         ...
         * @throws AccessDeniedException Thrown if the user doesn't have required permissions
         ENDIF
         */
        public function interactiveinitstep3IF !targets('1.3.5')ActionENDIF()
        {
            IF targets('1.3.5')
                $this->throwForbiddenUnless(SecurityUtil::checkPermission('::', '::', ACCESS_ADMIN));
            ELSE
    ...
    def private funcInteractiveUpdate(Application it) '''
         ...
         * @throws AccessDeniedException Thrown if the user doesn't have required permissions
         ENDIF
         */
        public function upgradeIF !targets('1.3.5')ActionENDIF()
        {
            IF targets('1.3.5')
                $this->throwForbiddenUnless(SecurityUtil::checkPermission('::', '::', ACCESS_ADMIN));
            ELSE
    ...
    def private funcInteractiveDelete(Application it) '''
         ...
         * @throws AccessDeniedException Thrown if the user doesn't have required permissions
         ENDIF
         */
        public function uninstallIF !targets('1.3.5')ActionENDIF()
        {
            IF targets('1.3.5')
                $this->throwForbiddenUnless(SecurityUtil::checkPermission('::', '::', ACCESS_ADMIN));
            ELSE
