...
class ValidationConstraints {
    ...
    def private fieldAnnotationsString(AbstractStringField it) '''
        ...
        IF regexp !== null && regexp != ''
            ' '* @Assert\Regex(pattern="regexp"IF regexpOpposite, match=falseENDIF)
        ENDIF
    '''
    ...
    def dispatch fieldAnnotations(ListField it) '''
        fieldAnnotationsMandatory
        ' '* @Assert\Choice(callback="getname.formatForCodeCapitalAllowedValues", multiple=multiple.displayBoolIF multipleIF min > 0, min=minENDIFIF max > 0, max=maxENDIFENDIF)
    '''
    ...
    def dispatch validationMethods(ListField it) '''
         ...
         */
        static public function getname.formatForCodeCapitalAllowedValues()
        {
            ...
            ENDIF
            $listEntries = $helper->getname.formatForCodeCapitalEntriesForentity.name.formatForCodeCapital();
    ...
    def dispatch validationMethods(UserField it) '''
         ...
         */
        public function isname.formatForCodeCapitalUserValid()
        {
            IF !mandatory
    ...
    def dispatch validationMethods(DatetimeField it) '''
        IF mandatory
            IF past
                 ...
                 */
                public function isname.formatForCodeCapitalDateTimeValidPast()
                {
                    $format = 'U';
            ...
            IF future
                 ...
                 */
                public function isname.formatForCodeCapitalDateTimeValidFuture()
                {
                    $format = 'U';
                    return $this['name.formatForCode']->format($format) > date($format);
                }
        ...
        IF startDate
            ...
            IF endDateField !== null
                 ...
                 */
                public function isname.formatForCodeCapitalBeforeendDateField.name.formatForCodeCapital()
                {
    ...
    def dispatch validationMethods(DateField it) '''
        IF mandatory
            IF past
                 ...
                 * @Assert\True(message="This value must be a date in the past.")
                 */
                public function isname.formatForCodeCapitalDateValidPast()
                {
                    $format = 'Ymd';
                    return $this['name.formatForCode']->format($format) < date($format);
                }
            ...
            IF future
                 ...
                 * @Assert\True(message="This value must be a date in the future.")
                 */
                public function isname.formatForCodeCapitalDateValidFuture()
                {
                    $format = 'Ymd';
                    return $this['name.formatForCode']->format($format) > date($format);
                }
    ...
    def dispatch validationMethods(TimeField it) '''
        IF mandatory
            IF past
                 ...
                 */
                public function isname.formatForCodeCapitalTimeValidPast()
                {
                    $format = 'His';
                    return $this['name.formatForCode']->format($format) < date($format);
                }
            ...
            IF future
                 ...
                 */
                public function isname.formatForCodeCapitalTimeValidFuture()
                {
                    $format = 'His';
                    return $this['name.formatForCode']->format($format) > date($format);
                }
