...
class TemplateSelector {
    ...
    def private selectorTemplatesImpl(Application it) '''
        /**
         * The appName.formatForDBTemplateSelector plugin provides items for a dropdown selector.
         *
         ...
         */
        function smarty_function_appName.formatForDBTemplateSelector($params, $view)
        {
