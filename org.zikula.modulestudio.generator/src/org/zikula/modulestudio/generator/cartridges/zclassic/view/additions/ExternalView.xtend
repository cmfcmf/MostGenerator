...
class ExternalView {
    ...
    def private displayTemplate(Entity it, Application app) '''
        ...
        {if $displayMode eq 'link'}
            <pIF app.hasUserController class="app.appName.toLowerCase-external-link"ENDIF>
            IF app.hasUserController
                ...
                ELSE
                    <a href="{route name='app.appName.formatForDB_name.formatForCode_display' routeParams(name.formatForCode, true)}" title="{$name.formatForCode->getTitleFromDisplayPattern()|replace:"\"":""}">
                ENDIF
            ENDIF
    ...
    def private findTemplate(Entity it, Application app) '''
        ...
        <head>
            ...
            <link type="text/css" rel="stylesheet" href="{$baseurl}app.rootFolder/IF app.targets('1.3.5')app.appName/style/ELSEapp.getAppCssPathENDIFstyle.css" />
            <link type="text/css" rel="stylesheet" href="{$baseurl}app.rootFolder/IF app.targets('1.3.5')app.appName/style/ELSEapp.getAppCssPathENDIFfinder.css" />
            ...
            <script type="text/javascript">/* <![CDATA[ */
                ...
                ENDIF
            <script type="text/javascript" src="{$baseurl}app.rootFolder/IF app.targets('1.3.5')app.appName/javascript/ELSEapp.getAppJsPathENDIFapp.appNameIF app.targets('1.3.5')_fELSE.FENDIFinder.js"></script>
        IF app.targets('1.3.5')
        ...
        <body>
            ...
            <form action="{$ourEntry|default:'index.php'}" id="app.appName.toFirstLowerSelectorForm" method="get" class="IF app.targets('1.3.5')z-formELSEform-horizontalENDIF"IF !app.targets('1.3.5') role="form"ENDIF>
            <div>
                ...
                <fieldset>
                    ...
                    <input type="submit" id="app.appName.toFirstLowerSubmit" name="submitButton" value="{gt text='Change selection'}"IF !app.targets('1.3.5') class="btn btn-success"ENDIF />
                    <input type="button" id="app.appName.toFirstLowerCancel" name="cancelButton" value="{gt text='Cancel'}"IF !app.targets('1.3.5') class="btn btn-default"ENDIF />
                    <br />
                </fieldset>
            </div>
            </form>
    ...
    def private findTemplateObjectTypeSwitcher(Entity it, Application app) '''
        IF app.getAllEntities.size > 1
            ...
            ELSE
                ...
                FOR entity : app.getAllEntities.filter[e|e.name != name] SEPARATOR ' | '
                    <li{if $objectType eq 'entity.name.formatForCode'} class="active"{/if}><a href="{route name='app.appName.formatForDB_external_finder' objectType='entity.name.formatForCode' editor=$editorName}" title="{gt text='Search and select entity.name.formatForDisplay'}">{gt text='entity.nameMultiple.formatForDisplayCapital'}</a></li>
                ENDFOR
                </ul>
            ENDIF
        ENDIF
        ...
        IF categorisable
            ...
            {if $properties ne null && is_array($properties)}
                ...
                {foreach key='propertyName' item='propertyId' from=$properties}
                    <div class="IF app.targets('1.3.5')z-formrowELSEform-groupENDIF categoryselector">
    ...
    def private findTemplatePasteAs(Entity it, Application app) '''
        <div class="IF app.targets('1.3.5')z-formrowELSEform-groupENDIF">
            <label for="app.appName.toFirstLowerPasteAs"IF !app.targets('1.3.5') class="col-lg-3 control-label"ENDIF>{gt text='Paste as'}:</label>
            IF !app.targets('1.3.5')
                <div class="col-lg-9">
            ENDIF
                <select id="app.appName.toFirstLowerPasteAs" name="pasteas"IF !app.targets('1.3.5') class="form-control"ENDIF>
    ...
    def private findTemplateObjectId(Entity it, Application app) '''
        <div class="IF app.targets('1.3.5')z-formrowELSEform-groupENDIF">
            <label for="app.appName.toFirstLowerObjectId"IF !app.targets('1.3.5') class="col-lg-3 control-label"ENDIF>{gt text='name.formatForDisplayCapital'}:</label>
            IF !app.targets('1.3.5')
                <div class="col-lg-9">
            ENDIF
                <div id="app.appName.toLowerCaseItemContainer">
                    <ul>
                    {foreach item='name.formatForCode' from=$items}
                        <li>
                            ...
                            <input type="hidden" id="url{$name.formatForCode.getFirstPrimaryKey.name.formatForCode}" value="IF app.hasUserControllerIF app.targets('1.3.5'){modurl modname='app.appName' type='user' func='display' ot='name.formatForCode' routeParamsLegacy(name.formatForCode, true, true) fqurl=true}ELSE{route name='app.appName.formatForDB_name.formatForCode_display' routeParams(name.formatForCode, true) absolute=true}ENDIFENDIF" />
    ...
    def private findTemplateSorting(Entity it, Application app) '''
        <div class="IF app.targets('1.3.5')z-formrowELSEform-groupENDIF">
            <label for="app.appName.toFirstLowerSort"IF !app.targets('1.3.5') class="col-lg-3 control-label"ENDIF>{gt text='Sort by'}:</label>
            IF !app.targets('1.3.5')
                <div class="col-lg-9">
            ENDIF
                <select id="app.appName.toFirstLowerSort" name="sort" style="width: 150px" class="IF app.targets('1.3.5')z-floatleftELSEpull-leftENDIF" style="margin-right: 10px">
                ...
                <select id="app.appName.toFirstLowerSortDir" name="sortdir" style="width: 100px"IF !app.targets('1.3.5') class="form-control"ENDIF>
    ...
    def private findTemplatePageSize(Entity it, Application app) '''
        <div class="IF app.targets('1.3.5')z-formrowELSEform-groupENDIF">
            <label for="app.appName.toFirstLowerPageSize"IF !app.targets('1.3.5') class="col-lg-3 control-label"ENDIF>{gt text='Page size'}:</label>
            IF !app.targets('1.3.5')
                <div class="col-lg-9">
            ENDIF
                <select id="app.appName.toFirstLowerPageSize" name="num" style="width: 50px; text-align: right"IF !app.targets('1.3.5') class="form-control"ENDIF>
    ...
    def private findTemplateSearch(Entity it, Application app) '''
        IF hasAbstractStringFieldsEntity
            <div class="IF app.targets('1.3.5')z-formrowELSEform-groupENDIF">
                <label for="app.appName.toFirstLowerSearchTerm"IF !app.targets('1.3.5') class="col-lg-3 control-label"ENDIF>{gt text='Search for'}:</label>
            IF !app.targets('1.3.5')
                <div class="col-lg-9">
            ENDIF
                    <input type="text" id="app.appName.toFirstLowerSearchTerm" name="searchterm" style="width: 150px" class="IF app.targets('1.3.5')z-floatleftELSEform-control pull-leftENDIF" style="margin-right: 10px" />
                    <input type="button" id="app.appName.toFirstLowerSearchGo" name="gosearch" value="{gt text='Filter'}" style="width: 80px"IF !app.targets('1.3.5') class="btn btn-default"ENDIF />
            IF !app.targets('1.3.5')
                </div>
            ENDIF
            </div>
    ...
    def private selectTemplate(Entity it, Application app) '''
        ...
        <div id="{$baseID}Preview" style="float: right; width: 300px; border: 1px dotted #a3a3a3; padding: .2em .5em; margin-right: 1em">
            ...
            {img id='ajax_indicator' modname='core' set='ajax' src='indicator_circle.gif' alt='' class='IF app.targets('1.3.5')z-hideELSEhiddenENDIF'}
        ...
        IF hasAbstractStringFieldsEntity
            <p>
                ...
                <input type="button" id="app.appName.toFirstLowerSearchGo" name="gosearch" value="{gt text='Filter'}"IF !app.targets('1.3.5') class="btn btn-default"ENDIF />
                <br{$break} />
            </p>
        ENDIF
        <br />
